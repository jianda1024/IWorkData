...
class DataBus:
    ...
    def __init__(self, stock_code):
        self.AwayBus: DataBus._AwayBus = DataBus._AwayBus()  # 历史数据
        self.HereBus: DataBus._HereBus = DataBus._HereBus()  # 当天数据
        self.CurrPos: DataBus._CurrPos = DataBus._CurrPos()  # 当前仓位
